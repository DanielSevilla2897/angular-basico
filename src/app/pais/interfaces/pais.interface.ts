...
//
//   const rESTCountriesRequest = Convert.toRESTCountriesRequest(json);
//
...
export class Convert {
    public static toRESTCountriesRequest(json: string): Country[] {
        return cast(JSON.parse(json), a(r("RESTCountriesRequest")));
    }

    public static rESTCountriesRequestToJson(value: Country[]): string {
        return JSON.stringify(uncast(value, a(r("RESTCountriesRequest"))), null, 2);
    }
}
