...
//
//   const countryCode = Convert.toCountryCode(json);
//
...
export class Convert {
    public static toCountryCode(json: string): CountryCode[] {
        return cast(JSON.parse(json), a(r("CountryCode")));
    }

    public static countryCodeToJson(value: CountryCode[]): string {
        return JSON.stringify(uncast(value, a(r("CountryCode"))), null, 2);
    }
}
